...
const FinishRide = (props) => {
  ...
  return (
    ...
    <div className='flex items-center justify-between  p-4 rounded-lg border-2 border-yellow-300 '>
    ...
    <div className='flex flex-col gap-2 justify-between items-center'>
      <div className='w-full mt-5'>
        ...
        <div className='mt-6 w-full'>
            ...
            <Link to='/captain-home' className='w-full mt-5 flex bg-green-400 justify-center  text-white font-semibold p-2 rounded-lg' >Finish Ride</Link>
            <p className='mt-5 text-xs'>click on finsh ride button if you completed the payment</p>
        </div>
      </div>
    </div>
  </div>
